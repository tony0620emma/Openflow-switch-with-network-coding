...
my $nf2_action_flag = 0x0008;  # OFPAT_STRIP_VLAN
my $set_vlan_vid = 0;
my $set_vlan_pcp = 0;
my $set_dl_src = 0;
my $set_dl_dst = 0;
...
# Send pkt w/ VLAN tag, expect pkt w/o VLAN tag
...
$delay_us += NFOpenFlowTester::runRandomSim(\&NFOpenFlowTester::expDifferentPkt,
					    ...
					    NFOpenFlowTester::FLOW_ENTRY_FIELDS() => $fields_with_vlan,
					    NFOpenFlowTester::PKT_FIELDS() => $fields_with_vlan,
