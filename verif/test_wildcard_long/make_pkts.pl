...
my $fields =
  {NFUtils::SimplePacket::TRANSP_DST() => [NFOpenFlowTester::WILDCARD, 0x1111],
   NFUtils::SimplePacket::TRANSP_SRC() => [NFOpenFlowTester::WILDCARD, 0x2222],
   NFUtils::SimplePacket::IP_PROTO() => [NFOpenFlowTester::WILDCARD, NFUtils::SimplePacket::IP_PROTO_UDP],
   NFUtils::SimplePacket::IP_DST() => [NFOpenFlowTester::WILDCARD, 0x4222224],
   NFUtils::SimplePacket::IP_SRC() => [NFOpenFlowTester::WILDCARD],
   NFUtils::SimplePacket::ETH_TYPE() => [NFOpenFlowTester::WILDCARD, NFUtils::SimplePacket::ETH_TYPE_IP],
   NFUtils::SimplePacket::ETH_DST() => [NFOpenFlowTester::WILDCARD, "88:11:11:11:11:88"],
   NFUtils::SimplePacket::ETH_SRC() => [NFOpenFlowTester::WILDCARD, "77:11:11:11:11:77"],
   NFUtils::SimplePacket::SRC_PORT() => [0, 2, 4, 6],
   NFUtils::SimplePacket::IP_TOS() => [0],
   NFUtils::SimplePacket::VLAN_TAG() => [0x999, 0, 0xffff, NFOpenFlowTester::WILDCARD],
