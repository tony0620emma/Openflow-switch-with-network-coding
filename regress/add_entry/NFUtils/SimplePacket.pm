...
#
# $Id: SimplePacket.pm 3703M 2008-08-03 17:28:17Z (local) $
...
sub new {
  ...
  $arg{ETH_TYPE()} = int(rand(0xf9ff)) + 0x600 unless(defined $arg{ETH_TYPE()});
...
sub get {
  ...
  return $self->{PKT_LEN()} if($field eq PKT_LEN);
