...
sub new {
  ...
  my $format = {'forward' => {'pos' => main::OPENFLOW_FORWARD_BITMASK_POS()/8,
                              'width' => main::OPENFLOW_FORWARD_BITMASK_WIDTH()/8,
                              'to_bytes' => \&ByteArrayUtils::int_to_bytes,
                              'from_bytes' => \&ByteArrayUtils::bytes_to_int}
#               'pkt_trim' => {'pos' => main::OPENFLOW_PKT_TRIM_ACTION_POS()/8,
#                              'width' => main::OPENFLOW_PKT_TRIM_ACTION_WIDTH()/8,
#                              'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                              'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'vlan_mod' => {'pos' => main::OPENFLOW_VLAN_MOD_ACTION_POS()/8,
#                              'width' => main::OPENFLOW_VLAN_MOD_ACTION_WIDTH()/8,
#                              'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                              'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'replacement_action_0' => {'pos' => main::OPENFLOW_REPLACEMENT_ACTION_POS()/8,
#                                          'width' => main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                          'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'replacement_action_1' => {'pos' => main::OPENFLOW_REPLACEMENT_ACTION_POS()/8 + main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'width' => main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                          'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'replacement_action_2' => {'pos' => main::OPENFLOW_REPLACEMENT_ACTION_POS()/8 + 2*main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'width' => main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                          'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'replacement_action_3' => {'pos' => main::OPENFLOW_REPLACEMENT_ACTION_POS()/8 + 3*main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'width' => main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                          'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'replacement_action_4' => {'pos' => main::OPENFLOW_REPLACEMENT_ACTION_POS()/8 + 4*main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'width' => main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                          'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'replacement_action_5' => {'pos' => main::OPENFLOW_REPLACEMENT_ACTION_POS()/8 + 5*main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'width' => main::OPENFLOW_REPLACEMENT_ACTION_WIDTH()/8,
#                                          'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                          'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'replacement_bitmask_action_0' => {'pos' => main::OPENFLOW_REPLACEMENT_BITMASK_ACTION_POS()/8,
#                                                  'width' => main::OPENFLOW_REPLACEMENT_BITMASK_ACTION_WIDTH()/8,
#                                                  'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                                  'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'replacement_bitmask_action_1' => {'pos' => main::OPENFLOW_REPLACEMENT_BITMASK_ACTION_POS()/8 + main::OPENFLOW_REPLACEMENT_BITMASK_ACTION_WIDTH()/8,
#                                                  'width' => main::OPENFLOW_REPLACEMENT_BITMASK_ACTION_WIDTH()/8,
#                                                  'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                                  'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'increment_action_0' => {'pos' => main::OPENFLOW_INCREMENT_ACTION_POS()/8,
#                                        'width' => main::OPENFLOW_INCREMENT_ACTION_WIDTH()/8,
#                                        'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                        'from_bytes' => \&ByteArrayUtils::bytes_to_int},
#               'increment_action_1' => {'pos' => main::OPENFLOW_INCREMENT_ACTION_POS()/8 + main::OPENFLOW_INCREMENT_ACTION_WIDTH()/8,
#                                        'width' => main::OPENFLOW_INCREMENT_ACTION_WIDTH()/8,
#                                        'to_bytes' => \&ByteArrayUtils::int_to_bytes,
#                                        'from_bytes' => \&ByteArrayUtils::bytes_to_int}
...
sub new {
  ...
  if(defined $arg{'debug'} && $arg{'debug'}) {
    ...
    $table->{'reg_write'} = \&NF::TestLib::nftest_regwrite;
    $table->{'reg_read'} = \&NF::TestLib::nftest_regread;
    $table->{'reg_read_expect'} = \&NF::TestLib::nftest_regread_expect;
    $table->{'reg_read_expect_masked'} = \&NF::TestLib::nftest_regread_expect;
...
sub writeWildcardEntry {
  ...
  foreach my $i (0..$#hdr_data_words) {
    $self->{'reg_write'}->(@{$self->{reg_aux}},
                           main::OPENFLOW_WILDCARD_LOOKUP_CMP_BASE_REG() + $i*4,
                           $hdr_data_words[$i]);
    $self->{'reg_write'}->(@{$self->{reg_aux}},
                           main::OPENFLOW_WILDCARD_LOOKUP_CMP_MASK_BASE_REG() + $i*4,
                           $hdr_dmask_words[$i]);
  ...
  foreach my $i (0..$#action_words) {
    $self->{'reg_write'}->(@{$self->{reg_aux}},
                           main::OPENFLOW_WILDCARD_LOOKUP_ACTION_BASE_REG() + $i*4,
                           $action_words[$i]);
  }
  ...
  $self->{'reg_write'}->(@{$self->{reg_aux}},
                         main::OPENFLOW_WILDCARD_LOOKUP_BYTES_HIT_BASE_REG() + $index*4,
                         0);
  $self->{'reg_write'}->(@{$self->{reg_aux}},
                         main::OPENFLOW_WILDCARD_LOOKUP_PKTS_HIT_BASE_REG() + $index*4,
                         0);
...
sub writeExactEntry {
  ...
  foreach my $i (0..$#hdr_data_words) {
    $self->{'reg_write'}->(@{$self->{reg_aux}},
                           main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_HDR_BASE_POS()*4 + $i*4 + $index,
                           $hdr_data_words[$i]);
    printf "Writing %08x into address %08x.\n", $hdr_data_words[$i], main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_HDR_BASE_POS()*4 + $i*4 + $index;
  }
  ...
  $self->{'reg_write'}->(@{$self->{reg_aux}},
                         main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_COUNTERS_POS()*4 + $index,
                         ($timestamp & 0x7f) << main::OPENFLOW_EXACT_ENTRY_LAST_SEEN_POS());
  printf "Writing %08x into address %08x.\n", ($timestamp & 0x7f) << main::OPENFLOW_EXACT_ENTRY_LAST_SEEN_POS(), main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_COUNTERS_POS()*4 + $index;

  # write byte counter
  $self->{'reg_write'}->(@{$self->{reg_aux}},
                         main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_COUNTERS_POS()*4 + 4 + $index,
                         0);
  printf "Writing %08x into address %08x.\n", 0, main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_COUNTERS_POS()*4 + 4 + $index,

  # write the actions
  my @action_words = $action->littleEndianWords();
  foreach my $i (0..$#action_words) {
    $self->{'reg_write'}->(@{$self->{reg_aux}},
                           main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_ACTION_BASE_POS()*4 + $index + $i*4,
                           $action_words[$i]);
    printf "Writing %08x into address %08x.\n", $action_words[$i], main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_ACTION_BASE_POS()*4 + $i*4 + $index;
  }
...
sub deleteExactEntry {
  ...
  $self->{'reg_write'}->(@{$self->{reg_aux}},
                         main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_HDR_BASE_POS()*4 + 7*4 + $index,
                         0);
...
sub checkCounters {
  ...
  foreach my $i(0..main::OPENFLOW_WILDCARD_TABLE_SIZE()-1) {
    if(defined $self->{wildcard}->{entries}->[$i]->{header}) {
      $self->{'reg_read_expect'}->(@{$self->{reg_aux}},
                                   main::OPENFLOW_WILDCARD_LOOKUP_BYTES_HIT_BASE_REG() + $i*4,
                                   $self->{wildcard}->{entries}->[$i]->{bytes_hit});
      $self->{'reg_read_expect'}->(@{$self->{reg_aux}},
                                   main::OPENFLOW_WILDCARD_LOOKUP_PKTS_HIT_BASE_REG() + $i*4,
  ...
  foreach my $i(keys %{$self->{exact}->{entries}}) {
    $self->{'reg_read_expect_masked'}->(@{$self->{reg_aux}},
                                        main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_COUNTERS_POS()*4 + $i,
                                        $self->{exact}->{entries}->{$i}->{pkts_hit},
                                        0xffffff);
    $self->{'reg_read_expect'}->(@{$self->{reg_aux}},
                                 main::SRAM_BASE_ADDR_REG() + main::OPENFLOW_EXACT_ENTRY_COUNTERS_POS()*4 + $i + 4,
